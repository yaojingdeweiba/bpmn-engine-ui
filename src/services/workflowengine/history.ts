...
/** Query activity instance history GET /history/activity-instance */
export async function getHistoryActivityInstance(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getHistoryActivityInstanceParams,
  options?: { [key: string]: any }
) {
  return request<any>("/history/activity-instance", {
    method: "GET",
    params: {
...
/** Query history of process instances GET /history/process-instance */
export async function getHistoryProcessInstance(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getHistoryProcessInstanceParams,
  options?: { [key: string]: any }
) {
  return request<any>("/history/process-instance", {
    method: "GET",
    params: {
...
/** Get a specific process instance from history GET /history/process-instance/${param0} */
export async function getHistoryProcessInstanceId(
  ...
  return request<any>(`/history/process-instance/${param0}`, {
    method: "GET",
    params: { ...queryParams },
    ...(options || {}),
  });
...
/** Query variable instance history GET /history/variable-instance */
export async function getHistoryVariableInstance(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getHistoryVariableInstanceParams,
  options?: { [key: string]: any }
) {
  return request<any>("/history/variable-instance", {
    method: "GET",
    params: {
